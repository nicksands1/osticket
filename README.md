...
- Go back to the browser and click Continue
  ...
  - Last Name: Last name
  - Email Address: Email of choice(should be different from the helpdesk's default email)
  - Username: admin 
  - Password: Password1 
...
- Go back to the browser
	- MySQL Database: osTicket (the one you created in HeidiSQL)
	- MySQL Username: root
...
You have sucessfully installed osTicket and all of its pre-requisite files.
